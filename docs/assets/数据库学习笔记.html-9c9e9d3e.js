import{_ as s,o as n,c as a,e}from"./app-be4917b4.js";const t={},p=e(`<h1 id="数据库学习笔记" tabindex="-1"><a class="header-anchor" href="#数据库学习笔记" aria-hidden="true">#</a> 数据库学习笔记</h1><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token comment">--创建数据库test --</span>
